...
/*-----------------------------------------------
              @(target):= _pyapp_wrapper.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pyapp_wrapper

#else
#  define SWIG_init    init_pyapp_wrapper

#endif
#define SWIG_name    "_pyapp_wrapper"
